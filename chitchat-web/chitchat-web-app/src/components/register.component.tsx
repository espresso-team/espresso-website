    ...
    return Yup.object().shape({
      ...
      password: Yup.string()
        .test(
          ...
          (val: any) =>
            val && val.toString().length >= 8 && val.toString().length <= 72
        )
        .required("This field is required!"),
    });
  }
      ...
      <div className="col-md-12">
        ...
        <div className="card card-container">
          ...
          <button
            ...
            data-ga='["sign up","Sign Up Started - GitHub","Question Hero",null,null]'
          >
            <svg
              viewBox="0 0 28 28"
              width="18"
              ...
              className="css-1whn15r"
            >
              <rect width="28" height="28" fill="#3B99FC"></rect>
              <path
